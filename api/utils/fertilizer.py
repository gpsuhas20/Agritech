fertilizer_dict = {
        ...
        1.Use mulch (wet grass) while growing crops - Mulch can also include sawdust and scrap soft woods """,
        ...
        'NNo': """The N value of your soil is up to the mark.<hr style """,
        ...
        2. <i>Sift through the soil, and remove as many rocks as possible, using a soil sifter. Minerals occurring in rocks such as mica and feldspar slowly release potassium into the soil slowly through weathering.
        ...
        3. Try Sul-Po-Mag
        4. Bury banana peels an inch below the soils surface</p>
